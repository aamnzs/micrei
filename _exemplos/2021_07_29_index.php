							...
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="container-fluid" align="center">
										<button type="button" class="btn btn-outline-info btn-sm" data-toggle="modal" data-target="#exampleModal">Aquecendo os neurônios</button>
									</div>
								</div>
							</div>
							<div class="card">
								...
								<div class="card-body">
									<p class="card-text text-center">Conheça nossas ferramentas de suporte administrativo, operacional e gerencial.</p>
									...
									<div class="container-fluid" align="center">
										<button type="button" class="btn btn-outline-info btn-sm" data-toggle="modal" data-target="#exampleModal">Exercitando os músculos</button>
									</div>
								</div>
							</div>
							<div class="container-fluid">
