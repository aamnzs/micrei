            ...
            <div class="card border-0">
                <div class="card-text alert-info text-primary"><p><h3 align="center">Ambiente para interação</h3></p></div>
                    <div class="card-body bg-faded">
                        <h6 align="center">Sua iniciativa nos alegra</h6>
                        <p class="card-text"></p>
                        <form class="row g-3">
                            <div class="container">
                                <div class="container-fluid">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select class="form-select form-control is-valid" id="validationServer04" align="center" required>
                                            <option  value="">Selecione o motivo do seu contato</option>
                                            <option>Dúvidas</option>
                                            <option>Sugestões</option>
                                            <option>Erros percebidos</option>
                                            <option>Outros motivos ...</option>
                                        </select>
                                    </div><br>
                                    <div class="col-md-12">
                                        <textarea class="form-control is-invalid" id="validationTextarea" placeholder="Descreva detalhadamente suas dúvidas, sugestões, erros percebidos ou outros motivos..." required></textarea>
                                    </div><br>
                                    ...
                                    <p class="card-text"><h6 align="center">Se preferir pode ligar ou enviar mensagem por Whatsapp</h6></p>
