    ...
    <?php
    include_once '../dados/inc/esqueleto.php';
    ?>
    <body>
                            ...
                            <div class="card-deck">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p align="center"><a href="/micrei/dados/funcionalidades/mentoria.php" target="_blank"><img src="https://www.imagensanimadas.com/data/media/56/computador-imagem-animada-0111.gif" width="150" border="0" alt="computador-imagem-animada-0111" /></a></p>
                                        <div class="container-fluid" align="center">
                                            <button type="button" class="btn btn-outline-info btn-sm"><a href="/micrei/dados/funcionalidades/mentoria.php" target="_blank">Aquecendo os neurônios</a></button>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p align="center"><a href="/micrei/dados/funcionalidades/ferramentas.php" target="_blank"><img src="https://www.imagensanimadas.com/data/media/411/trabalho-imagem-animada-0011.gif" width="150" border="0" alt="trabalho-imagem-animada-0011" /></a></p>
                                        <div class="container-fluid" align="center">
                                            <button type="button" class="btn btn-outline-info btn-sm"><a href="/micrei/dados/funcionalidades/ferramentas.php" target="_blank">Exercitando  os músculos</a></button>
                                        </div>
                                    </div>
                                </div>
                                <div class="container-fluid">
                                    <p align="center">Havendo necessidade de ajuda adicional, solicite suporte especializado.</p>
                                    <p align="center"><a href="/micrei/dados/funcionalidades/contato.php" target="_blank"><img src="https://www.imagensanimadas.com/data/media/235/e-mail-imagem-animada-0680.gif" width="150" border="0" alt="e-mail-imagem-animada-0680" /></a></p>
                                </div>
                            </div>
                        </div>
                    </span>
