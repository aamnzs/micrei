...
<html lang="pt-BR">
    ...
    ?>
    <body>
        <!-- Tópicos para FUNCIONALIDADES -->
        <div class="container-fluid">
            <div class="card border-0">
                <div class="card-text alert-info text-primary"><p><h3 align="center">F U N C I O N A L I D A D E S</h3></p>
                    <div><h6 align="center"><font color="#FF0000"><b><i>Página em construção!!</i></b></font></h6>
                        <p class="card-text text-center">Nos tópicos seguintes, descreveremos o básico que precisarás saber durante as principais etapas da jornada de um empreendedor.</p>
                        <p class="card-text text-center">Instigaremos seu raciocínio com perguntas e respostas, orientações de usos  etc</p>
                    </div>
