                    ...
                    <div class="container-fluid" align="center">
                        <form name="funcionalidade">
                            <select name="funcionalidades" class="col-md-6 form-control is-valid"  id="func" aria-label="Default select example" required>
                                ...
                                <option value="f_perfil.html">Avaliação de perfil</option>
                                <option value="f_ideias.html">Avaliação e seleção de ideias</option>
                                <option value="f_atividades.html">Seleção de atividades e modelos de negócios</option>
                                <option value="f_local.html">Localização do empreendimento</option>
                                <option value="f_planejamento.html">Planejamento estratégico</option>
                                <option value="f_processos.html">Principais processos de trabalhos</option>
                                <option value="f_investimentos.html">Captação de investimentos</option>
                                <option value="f_formalizar.html">Formalização do empreendimento</option>
                                <option value="f_colaboradores.html">Seleção e contratação de colaboradores</option>
                                <option value="f_ferramentas.html">Ferramentas de apoio gerencial</option>
                            </select>
                        </form>
