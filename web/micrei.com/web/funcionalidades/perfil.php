			...
			<div class="card border-0">
				...
				<span class="border border-primary">
					<div class="card-text bg-faded">
						<ul><a href="#" target="_blank">Ferramenta X</a></ul>
						<ul><a href="#" target="_blank">Ferramenta Y</a></ul>
						<ul><a href="#" target="_blank">Ferramenta W</a></ul>
						<ul><a href="#" target="_blank">Ferramenta Z</a></ul>
						<ul><a href="#" target="_blank">Ferramenta ...</a></ul>
<!-- Links ATIVOS para Endeavor
